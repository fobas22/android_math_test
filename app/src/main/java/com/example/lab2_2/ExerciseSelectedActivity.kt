...
class ExerciseSelectedActivity : AppCompatActivity() {
    ...
    private var selectedNumber: Int = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_exercise_selected)

        questionTextView = findViewById(R.id.question_text_view2)
        answerTextView = findViewById(R.id.answer_text_view2)
        resultTextView = findViewById(R.id.result_text_view2)
    ...
    private fun generateQuestion() {
        ...
        questionTextView.text = "$selectedNumber x $secondNumber = "
        answerTextView.text = ""
    }
